...
- [x] **MENU-04**: Clicking a product card opens a detail modal with full description and effects
- [x] **MENU-05**: Product detail modal contains a media gallery — user can browse through all images and videos the owner uploaded for that product
...
*Last updated: 2026-03-02 after plan 05-01 completion (MENU-04, MENU-05 marked complete — product modal and media gallery built in Phase 4; AUTH_URL added to env for Auth.js v5 compatibility)*
